...
%%%   adv_v, turn_v, dist_wp, wps_left,
%%%   yaw_odo, yaw_mag, yaw_fused, cal_status
%%% ═══════════════════════════════════════════════════════════════════════════
...
emit_serial(Row) ->
    ...
    #{lifecycle  := LC,
      ...
      yaw_fused  := YF,
      cal_status := CS} = Row,
    io:format("TLOG,~p,~p,~p,~.2f,~.2f,~.2f,~.2f,~.2f,~.2f,~p,~.2f,~.2f,~.2f,~p~n",
              [T_ms, LC, SS, X, Y, Speed, Adv, Turn, Dist, WpsL,
               YO, YM, YF, CS]).
